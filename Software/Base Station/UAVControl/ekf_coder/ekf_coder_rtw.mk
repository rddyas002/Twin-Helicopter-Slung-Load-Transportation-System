...
START_DIR                 = /home/yashren/Documents/MATLAB/FlightTests/c\ conversions/codegen/lib/ekf_coder
...
INCLUDES_BUILDINFO = -I/home/yashren/Documents/MATLAB/FlightTests/c\ conversions -I$(START_DIR) -I/home/yashren/Documents/MATLAB/FlightTests/c -I/home/yashren/Documents/MATLAB/FlightTests/c\ conversions/conversions -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert
...
%.o : /home/yashren/Documents/MATLAB/FlightTests/c\ conversions/%.c
	@echo "### Compiling "$<" ..."
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : /home/yashren/Documents/MATLAB/FlightTests/c\ conversions/%.cpp
	@echo "### Compiling "$<" ..."
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
