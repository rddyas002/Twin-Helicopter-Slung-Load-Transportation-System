...
LDLIBSOPTIONS=-lpthread `pkg-config --libs opencv` -larmadillo -lrt `pkg-config --libs cvblob` -lboost_system -lboost_signals-mt  
...
.build-conf: ${BUILD_SUBPROJECTS} nbproject/qt-${CND_CONF}.mk
	"${MAKE}" -f nbproject/qt-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/Helicomms
