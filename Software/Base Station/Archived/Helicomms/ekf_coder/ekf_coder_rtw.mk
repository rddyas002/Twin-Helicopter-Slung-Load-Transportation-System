...
MODEL                = ekf_coder
MODULES              = ekf_coder_rtwutil.cpp ekf_coder_initialize.cpp ekf_coder_terminate.cpp correctStateAndCov.cpp mpower.cpp eye.cpp inv.cpp eulerAnglesFromQuaternion.cpp projectStateAndCov.cpp quaternionRotation.cpp Reb.cpp ekf_coder_emxutil.cpp rt_nonfinite.cpp rtGetNaN.cpp rtGetInf.cpp 
...
MODELLIB                  = ekf_coder.lib
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = ekf_coder_ref.rsp
MODELREF_INC_PATH         = 
RELATIVE_PATH_TO_ANCHOR   = C:\Users\Yashren\DOCUME~1\Academia\Matlab\EKF_MO~1\CCONVE~1
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);C:\Users\Yashren\DOCUME~1\Academia\Matlab\EKF_MO~1\CCONVE~1
