...
**
** Created: Mon May 13 05:51:02 2013
...
static const char qt_meta_stringdata_ImageProcessing[] = {
    "ImageProcessing\0\0image1\0"
    "processingResult(QImage)\0"
};
...
void ImageProcessing::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->processingResult((*reinterpret_cast< const QImage(*)>(_a[1]))); break;
        default: ;
        }
    }
}

const QMetaObjectExtraData ImageProcessing::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject ImageProcessing::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_ImageProcessing,
      qt_meta_data_ImageProcessing, &staticMetaObjectExtraData }
};
...
// SIGNAL 0
void ImageProcessing::processingResult(const QImage _t1)
{
